...
//             Tab(text: "Food Counter Notifications"),
//           ],
//         ),
//       ),
//       body: TabBarView(
...
//     final highContrastTextColor = theme.brightness == Brightness.dark ? Colors.white : Colors.black;
//     final cardBackgroundColor = theme.brightness == Brightness.dark ? Colors.grey[800] : Colors.lightBlue[50];
//     final notificationBackgroundColor = theme.brightness == Brightness.dark ? Colors.orange[800] : Colors.orange[100];
...
//         Text(
//           "All Events Today",
//           style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: highContrastTextColor),
//         ),
//         SizedBox(height: 10),
...
//               style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: highContrastTextColor),
//             ),
...
//   void calculateTotalNotifications() {
//     setState(() {
//       totalNotifications = getEventNotificationsCount() + getFoodNotificationsCount();
//     });
...
//   int getEventNotificationsCount() {
//     // Logic to calculate event notifications
//     return 10;
//   }

//   int getFoodNotificationsCount() {
//     // Logic to calculate food notifications
//     return 5;
//   }
//   @override
//   void dispose() {
