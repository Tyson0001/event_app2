...
class _EventDetailsPageState extends State<EventDetailsPage> {
  ...
  void initState() {
    super.initState();
    // You can also load notification count when page is initialized if needed
  }
  ...
  @override
  Widget build(BuildContext context) {
    final eventDateTime = _parseDateTime(widget.event['date'] ?? '1 Jan', widget.event['time'] ?? '00:00');
