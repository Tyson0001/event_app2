...
//                         final likes = likeCounts[index] ?? 0;
...
class _ProjectListPageState extends State<ProjectListPage> {
  ...
  // URL to fetch projects from
  static const String baseUrl = 'https://gatherhub-r7yr.onrender.com/user/conference/DP2024';
  ...
  try {
    ...
    // Create an HTTP client with redirect handling
    ...
    try {
      ...
      if (streamedResponse.statusCode == 200 || streamedResponse.statusCode == 307) {
        // Parse the response to get the updated like count
        final responseBody = json.decode(response.body);
        // print('Response body: $responseBody');
        
        // Adjust this line based on the exact structure of your response
        final updatedLikeCount = responseBody['likes'] ?? responseBody['likeCount'] ?? 0;
        ...
        // Handle server error
        _showErrorSnackBar('Failed to update like status. Status code: ${streamedResponse.statusCode}');
    ...
    print("Error: $e");
    _showErrorSnackBar('Error2: ${e.toString()}');
